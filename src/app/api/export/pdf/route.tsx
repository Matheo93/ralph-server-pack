 ...
 * - GET: weekly, monthly, child reports (pdf-export service)
 * - POST: charge reports, tasks history (templates/pdf)
 */
...
// =============================================================================
// GET - Generate PDF (weekly, monthly, child reports)
// =============================================================================
...
// =============================================================================
// POST - Generate PDF (charge reports, tasks history)
// =============================================================================

/**
 * POST /api/export/pdf
 * Body: { type: "charge" | "tasks-history", period: "week" | "month" | "quarter" }
 *
 * Generate and return a PDF report
 */
