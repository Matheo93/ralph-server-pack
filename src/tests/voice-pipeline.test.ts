...
describe("Voice Transcription", () => {
  ...
  it("should validate audio blob size", async () => {
    const { validateAudioBlob } = await import("@/lib/voice/transcription")
  ...
  it("should validate audio blob max size", async () => {
    const { validateAudioBlob, MAX_AUDIO_SIZE } = await import("@/lib/voice/transcription")
  ...
  it("should check transcription configuration", async () => {
    const { isTranscriptionConfigured } = await import("@/lib/voice/transcription")
  ...
  it("should normalize transcribed text", async () => {
    const { normalizeText } = await import("@/lib/voice/transcription")
  ...
  it("should detect language from text", async () => {
    const { detectLanguage } = await import("@/lib/voice/transcription")
...
describe("Semantic Analysis", () => {
  ...
  it("should check analysis configuration", async () => {
    const { isAnalysisConfigured } = await import("@/lib/voice/semantic-analysis")

    const result = isAnalysisConfigured()
    expect(typeof result).toBe("boolean")
  })

  it("should parse relative dates in French", async () => {
    const { parseRelativeDate } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should convert urgency to priority", async () => {
    const { urgencyToPriority } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should have valid task categories", async () => {
    const { TASK_CATEGORIES } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should detect task category from keywords", async () => {
    const { detectCategoryFromText } = await import("@/lib/voice/semantic-analysis")
    ...
    expect(detectCategoryFromText("emmener à l'école")).toBe("logistique")
    expect(detectCategoryFromText("tâche quelconque")).toBe("autre")
  })

  it("should detect urgency from keywords", async () => {
    const { detectUrgencyFromText } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should extract child name from text", async () => {
    const { extractChildName } = await import("@/lib/voice/semantic-analysis")
...
describe("Analysis Prompts", () => {
  it("should generate valid system prompt", async () => {
    const { getSystemPrompt } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should generate prompt with children context", async () => {
    const { getSystemPrompt } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should generate English prompt", async () => {
    const { getSystemPrompt } = await import("@/lib/voice/semantic-analysis")
...
describe("Voice Recording Hook Types", () => {
  it("should export RecordingState type", async () => {
...
describe("Data Validation", () => {
  it("should validate extraction result structure", async () => {
  ...
  it("should validate transcription result structure", async () => {
...
describe("Edge Cases", () => {
  it("should handle empty text gracefully", async () => {
    const { detectCategoryFromText, detectUrgencyFromText } = await import(
      "@/lib/voice/semantic-analysis"
    )
  ...
  it("should handle null/undefined child names", async () => {
    const { extractChildName } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should handle case-insensitive child name matching", async () => {
    const { extractChildName } = await import("@/lib/voice/semantic-analysis")
  ...
  it("should handle unknown date formats", async () => {
    const { parseRelativeDate } = await import("@/lib/voice/semantic-analysis")
