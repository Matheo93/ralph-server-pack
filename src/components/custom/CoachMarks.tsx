...
export const dashboardTourSteps: CoachStep[] = [
  {
    ...
    description: "Voyez en un coup d'oeil vos taches du jour, les retards, et la situation de votre famille.",
    position: "bottom",
  },
  {
    id: "magic-notepad",
    ...
    description: "Dictez ou ecrivez vos notes - l'IA les transforme automatiquement en taches classees!",
    position: "left",
  },
  {
    id: "today-tasks",
    ...
    description: "Votre liste de taches prioritaires. Cochez-les pour maintenir votre streak!",
    position: "right",
  },
  {
    id: "streak",
    ...
    title: "Votre Streak",
    description: "Completez vos taches critiques chaque jour pour augmenter votre streak!",
    position: "left",
  },
]
