...
const POPUP_DELAY_MS = 7200000 // 2 hours between popups - prevent overwhelming users
const INITIAL_DELAY_MS = 3600000 // 1 hour initial delay - let user settle in first
