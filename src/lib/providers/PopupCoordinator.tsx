...
const POPUP_DELAY_MS = 180000 // 3 minutes between popups - prevent overwhelming users
const INITIAL_DELAY_MS = 120000 // 2 minutes initial delay - let user settle in first
