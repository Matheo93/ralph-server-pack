...
const POPUP_DELAY_MS = 3600000 // 60 minutes between popups - prevent overwhelming users
const INITIAL_DELAY_MS = 1800000 // 30 minutes initial delay - let user settle in first
